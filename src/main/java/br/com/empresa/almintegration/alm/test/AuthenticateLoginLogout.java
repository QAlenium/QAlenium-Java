...
public class AuthenticateLoginLogout {
	...
	public static void main(String[] args) throws Exception {
		...
		new AuthenticateLoginLogout().authenticateLoginLogoutExample(
				"http://" + c.HOST + ":" +
						c.PORT + "/qcbin",
						c.DOMAIN,
						c.PROJECT,
	...
	public void authenticateLoginLogoutExample(final String serverUrl,
		...
		AuthenticateLoginLogout example =
	...
	public boolean login(String loginUrl, String username, String password)
		...
		Response response = con.httpGet(loginUrl, null, map, false);
	...
	public String isAuthenticated() throws Exception {
		...
		Response response = con.httpGet(isAuthenticateUrl, null, null, false);
